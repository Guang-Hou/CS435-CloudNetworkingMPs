...
class AdaptivePolicy(object):
    def __init__(self, topo, bwstats, logger):
        ...
        self.assignments = {}
        self.utilization = {}
        default = list(topo.coreSwitches.keys())[0]
    ...
    def minUtilization(self):
        ...
        smallest = float('inf')
        core = list(self.utilization.keys())[0]

        for switch, utilization in self.utilization.items():
            if utilization < smallest:
                smallest = utilization
                core = switch
        return core
...
class DefaultPolicy(object):
    ...
    def build(self, topo):
        ...
        core = list(topo.coreSwitches.keys())[0]
