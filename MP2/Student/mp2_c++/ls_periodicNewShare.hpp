...
void processSeqShare(char *recvBuff, int bytesRecvd, int newNeighborId) // when receiving header "seqs"
{
    ...
    string strSeq;
    strSeq.assign(recvBuff + 4, recvBuff + bytesRecvd);

    json LSA = json::parse(strSeq);
